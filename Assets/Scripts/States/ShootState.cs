...
namespace States
{
    public class ShootState : ICharacterState {
        ...
        private void FireArrows(int arrowCount) {
            ...
            var arrowSpeed = 50f;
            var velocity = CalculateBallisticVelocity(spawnPoint, target.transform.position, arrowSpeed);
            ...
            for (int i = 0; i < arrowCount; i++) {
                ...
                Debug.DrawRay(spawnPoint, finalVelocity * 5f, Color.red, .2f);
            }
        }
